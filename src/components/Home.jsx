        ...
        <div className="Home" >
            ...
            <div className="card text-center" style={{ width: '18rem', margin: 'auto' }}>
                ...
                <div className="card-body">
                    ...
                    <button className="bg-blue-500 text-white font-medium  py-2 px-4 hover:px-5 rounded hover:bg-blue-700 hover:text-gray-200 hover:font-bold ">Add to Cart</button>
                </div>
            </div>
        </div>
    )
